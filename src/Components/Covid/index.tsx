...
const CovidWrapper = () => {
    ...
    const buttons = ['Covid Dashboard', 'Reopening Zhovkva', 'Mask Up', 'For Individuals', 'Resourses for Businesses']
    return (
        <>
           <div className={classes.wrapper}>
                <div className={classes.wrapperInfo}>
                    <div className={classes.wrapperLeft}>
                        ...
                        <h2 className={classes.title}>Responding to COVID-19 in Pennsylvania</h2>
                        <p className={classes.dateText}>Last updated 4:00 p.m., September 23, 2020</p>
                    ...
                    <div className={classes.wrapperRight}>
                        ...
                        {buttons.map(b => (
                            <button className={classes.buttonsGuide}>
                                {b}
                            </button>
                        ))}
                    </div>
